{-# LANGUAGE ScopedTypeVariables, TypeSynonymInstances, MultiParamTypeClasses,
  FlexibleContexts, FlexibleInstances, TypeOperators, UndecidableInstances,
  DoAndIfThenElse, TemplateHaskell #-}
--------------------------------------------------------------------------------
-- |
...
import Prelude hiding (showList, sequence_)
...
import Poets.Contracts.Language.CSL.Typing.TypeInferer hiding (variableEnv, srcPos)
import Poets.Contracts.Language.CSL.Typing.Inference
import Poets.Contracts.Language.CSL.Render ()
import Control.Monad.Identity hiding (sequence_)
