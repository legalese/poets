{-# LANGUAGE TypeOperators, RankNTypes, MultiParamTypeClasses, TemplateHaskell,
  FlexibleContexts, FlexibleInstances, UndecidableInstances,
  TypeSynonymInstances, DoAndIfThenElse #-}
--------------------------------------------------------------------------------
-- |
...
runMatchM cs counter =
    ...
    (`runStateT` state) .
    (`runReaderT` Nothing) .
    runEquivT Set.singleton Set.union
